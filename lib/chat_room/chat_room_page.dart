...
import '../youtube_player/widgets/meta_data_title.dart';
                          ...
                          if (kIsWeb && constraints.maxWidth > 750) {
                            return Stack(
                              children: [
                                ...
                                // ),
                                player,
                                ChatForm(roomId: widget.room.id),
                                _messageList()
                  ...
                  appBar: AppBar(
                    ...
                    actions: [
                      ...
                      IconButton(
                        onPressed: (() {
                          final source =
                              'https://www.youtube.com/watch?v=HoLxK24GzE8';
                          if (source.startsWith('http://') ||
                              source.startsWith('https://')) {
                            YoutubePlayerController.convertUrlToId(source);

                            context.ytController.loadVideoById(videoId: source);
